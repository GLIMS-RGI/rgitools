...
print("rgitools: %s, %s" % (rgitools.__version__, rgitools.__file__))
...
project = 'rgitools'
copyright = '2015-{}, rgitools Developers'.format(datetime.datetime.now().year)
...
version = rgitools.version.short_version
# The full version, including alpha/beta/rc tags.
release = rgitools.__version__
...
latex_documents = [
  (master_doc, 'rgitools.tex', 'rgitools Documentation',
   'rgitools developers', 'manual'),
]
...
man_pages = [
    (master_doc, 'rgitools', 'rgitools documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'rgitools', 'rgitools documentation',
   author, 'rgitools', 'One line description of project.',
   'Miscellaneous'),
]
